...
// This method will rotate the list by given nodes
	public void rotateList(int n) {
		// Initially, current will point to head
		Node current = head;

		// n should not be 0 or greater than or equal to number of nodes present in the
		// list
		if (n == 0 || n >= size)
			return;
		else {
	...
	public static void main(String[] args) {
		Assignment2 dList = new Assignment2();
